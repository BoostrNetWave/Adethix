    ...
    >
      ...
      >
        <Stack useFlexGap>
          ...
          <p>Welcome to AdEthix!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Boostr NetWave Solutions’s Website, located at AdEthix.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use AdEthix if you do not agree to
          ...
          <p>You must not:</p>
          <ul>
            <li>Republish material from AdEthix </li>
            <li>Sell, rent or sub-license material from AdEthix </li>
            <li>Reproduce, duplicate or copy material from AdEthix </li>
            <li>Redistribute content from AdEthix </li>
          </ul>
